...
<section id="cheer-about">
    <div class="main-box">
        <div class="main-box-title">
            <h3>아프리카 치어리더</h3>
            <div></div>
        </div>
        <div class="cheer-about-des">
            <p>
                아프리카 치어리더팀은 1996년도부터 시작되어 꾸준히 치어리더들을 발굴하고 육성해 왔습니다. <br>
                2000년  시드니 올림픽과 2002년 한국 일본 월드컵을 시작으로 <br>
                2018 평창 올림픽, 2018 러시아 월드컵 까지 <br>
                다양한 국제스포츠 경기와 국내 기업들의 행사를 빛냈습니다.
            </p>
        </div>
    </div>
</section>
...
<section id="cheer-video">
    <div class="main-box">
        ...
        <div class="model-video-box">
            <iframe width="560" height="665" src="https://www.youtube.com/embed/CTahSEiZbDI" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>  
    </div>
</section>
...
<section id="model-gallery">
    ...
    <div class="model-gallery-box">
        ...
        <div><img src="/img/cheer/53.jpg" alt=""></div>
        <div><img src="/img/cheer/54.jpg" alt=""></div>
        <div><img src="/img/cheer/55.jpg" alt=""></div>
        <div><img src="/img/cheer/56.jpg" alt=""></div>
        <div><img src="/img/cheer/57.jpg" alt=""></div>
    </div>
</section>
...
<section id="model-career">
    ...
    <div class="model-careers">
        ...
        <div class="model-career-boxes">
            <h3><span>ㅡ</span>올림픽</h3>
            <ul class="model-career-box">
                <li>2000년시드니 올림픽</li>
                <li>2002년 한국-일본 월드컵</li>
                <li>2018년 평창올림픽</li>
                <li>2018년 러시아 월드컵</li>
            </ul>    
        </div>
